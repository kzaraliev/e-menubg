    ...
    content: (
      <>
        ...
        <section>
          ...
          <h3 className={styles.h3}>"Клиентите не знаят как да използват QR кодовете"</h3>
          ...
          <h3 className={styles.h3}>"По-възрастните клиенти имат затруднения"</h3>
    ...
    content: (
      <>
        <section>
          ...
          <p className={styles.p}>
            Да бъдеш "зелен" вече не е просто хубаво допълнение, а ключов фактор за привличане и задържане на клиенти. А знаете ли, че едно от най-лесните и ефективни решения за вашия ресторант да стане по-устойчив е преминаването към <strong>дигитално меню</strong>?
          </p>
        </section>
        ...
        <section>
          ...
          <p className={styles.p}>
            <strong>Решението с дигитално меню:</strong> Единствената "логистика" е преносът на данни през интернет, което има несравнимо по-нисък въглероден отпечатък.
          </p>
        </section>
...

  {
    ...
    content: (
      <>
        <section>
          <p className={styles.p}>
            Когато чуете "дигитално меню", вероятно си представяте <strong>QR код</strong>, който ви отвежда до онлайн версия на менюто. И това е чудесно – <strong>QR менютата</strong> са безспорно ефективни за по-добра хигиена и лесна актуализация.
          </p>
          <p className={styles.p}>
            Но какво, ако ви кажем, че <strong>електронното меню</strong> крие много повече потенциал, отколкото си представяте?
          </p>
          <p className={styles.p}>
            Ще разкрием 7 <strong>скрити ползи</strong> от модерните <strong>дигитални менюта</strong>, които могат буквално да изстрелят продажбите и да оптимизират всеки аспект от работата на вашето заведение през 2025 година.
          </p>
        </section>
      ...
      <>
        ...
        <section>
          ...
          <ul className={styles.ul}>
            ...
            <li className={styles.li}><strong>Сензорни прилагателни:</strong> "сочно", "ароматен", "хрупкав", "топящ се"</li>
            <li className={styles.li}><strong>Емоционални описания:</strong> Носталгия, удоволствие, екзотика</li>
          </ul>
        </section>

        <section>
          <h2 className={styles.h2}>3. "Златният триъгълник" и зони на внимание</h2>
          <p className={styles.p}>
            Изследванията показват, че човешкото око естествено се насочва към определени зони на страницата. Това е известно като "златния триъгълник".
          </p>
          <p className={styles.p}>
        ...
        <section>
          ...
          <ul className={styles.ul}>
            <li className={styles.li}><strong>Премахване на символа на валутата:</strong> "15.50" вместо "15.50 лв."</li>
            <li className={styles.li}><strong>Без подравняване:</strong> Затруднява сравнението</li>
            <li className={styles.li}><strong>Използване на '9':</strong> "14.99" вместо "15.00"</li>
            <li className={styles.li}><strong>Групиране на ястия:</strong> Насърчава поръчката на няколко артикула</li>
          </ul>
        </section>

        <section>
          <h2 className={styles.h2}>5. Ограничен избор и "Парадоксът на избора"</h2>
          <p className={styles.p}>
            Твърде много опции могат да парализират решението. "Парадоксът на избора" гласи, че колкото повече възможности имаме, толкова по-малко удовлетворени сме.
          </p>
          <p className={styles.p}>
        ...
        <section>
          ...
          <ul className={styles.ul}>
            <li className={styles.li}><strong>Етикети "Популярно":</strong> Хората следват мнозинството</li>
            <li className={styles.li}><strong>Препоръки за добавки:</strong> "Често поръчвано заедно с..."</li>
            <li className={styles.li}><strong>Ограничени количества:</strong> "Само 3 останали!"</li>
          </ul>
        </section>
